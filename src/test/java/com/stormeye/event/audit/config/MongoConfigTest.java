...
/**
 * Test for the Mongo Data Configuration.
 *
...
class MongoConfigTest {
    ...
    void mongoClientInjects() {
        ...
        assertThat(((MongoTemplate) mongoOperations).getDb().getName(), is("test-cspr-event-audit"));
        assertThat(gridFsOperations, is(instanceOf(GridFsTemplate.class)));
    }

    @Test
    void getDatabaseName() {
        assertThat(mongoConfig.getDatabaseName(), is("test-cspr-event-audit"));
    }
